...
import { Mail, ArrowRight, PenTool, Sparkles, Zap, User, Lock, Eye, EyeOff } from "lucide-react"
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 p-12 flex-col justify-between">
        ...
        <div className="space-y-6">
          <h1 className="text-4xl font-bold text-white leading-tight">
            Automate Your Blog Content with AI
          </h1>
          <p className="text-primary-100 text-lg">
            Join thousands of content creators who use AutoBlog to generate and publish SEO-optimized content automatically.
          </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Start automating your blog content today
              </p>
            </div>
